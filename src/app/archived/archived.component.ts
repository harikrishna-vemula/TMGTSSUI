...
export class ArchivedComponent implements OnInit {
 ...
 rowData: any
 GetArchivedScoreSheets()
   {
     //  alert("scoresheet working")
     this._logservice.GetArchivedScoreSheets().subscribe((data)=>{
       console.log(data,"archived sheet data");
 ...
 onGridReady(params : any) {
   ...
   this._logservice.GetArchivedScoreSheets()
     .subscribe((data: any) => {
 ...
 onBtExport() {
   const params = {
     columnKeys: ['id', 'applicantName','property','state','city','zip','standardDepositProperty', 'createdDate', 'createdDate','applicantType', 'applicationStatus'],
     fileName: 'Users'
   };
